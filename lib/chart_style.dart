...
class ChartColors {
  ...
  //背景颜色
  static const Color bgColor = Color(0xFF1F1511);
  static const Color kLineColor = Color(0xFFAFA8A5);
  static const Color gridColor = Color(0xFF291A14);
  static const List<Color> kLineShadowColor = [Color(0x554C86CD), Color(0x00000000)]; //k线阴影渐变
  static const Color ma5Color = Color(0xFF00F0FF);
  static const Color ma10Color = Color(0xFFD257C6);
  static const Color ma30Color = Color(0xFFF39A02);
//  static const Color upColor = Color(0xff4DAA90);
//  static const Color dnColor = Color(0xffC15466);
  static const Color upColor = Color(0xFF00E290);
  static const Color dnColor = Color(0xFFFE117B);
  static const Color volColor = Color(0xFFF39A02);

  static const Color macdColor = Color(0xFFF39A02);
  static const Color difColor = Color(0xFF00F0FF);
  static const Color deaColor = Color(0xFFD257C6);
  ...
  static const Color yAxisTextColor = Color(0xFFAFA8A5); //右边y轴刻度
  static const Color xAxisTextColor = Color(0xFFAFA8A5); //下方时间刻度
